...
from ..core.exceptions import MalformedArgument, UnsupportedArgument
from ..core.serializer import JSONSerializer, CompactSerializer
...
class Parser:
    ...
    @staticmethod
    def _parse_data(data: Any) -> Rawtext:
        """
        内部解析方法
